...
public class ActionConfig extends BaseConfig {
    ...
    /**
     * <p>
     * The internal name of this action mapping. If an action has a name, it may
     * be used as a shortcut in a URI. For example, an action with an
     * identification of "editPerson" may be internally forwarded as
     * "editPerson?id=1" which will then resolve to the real URI path at
     * execution time.
     * </p>
     *
     * @return the actionId
     ...
     *             if the identifier contains a forward slash
     */
     ...
     */
    protected void inheritExceptionHandlers(ActionConfig baseConfig) throws ClassNotFoundException, IllegalAccessException, InstantiationException,
     ...
     * @see #inheritFrom(ActionConfig)
     */
    protected void inheritForwards(ActionConfig baseConfig) throws ClassNotFoundException, IllegalAccessException, InstantiationException,
            InvocationTargetException
    {
        if (configured) {
            throw new IllegalStateException("Configuration is frozen");
     ...
     */
    public void inheritFrom(ActionConfig config) throws ClassNotFoundException, IllegalAccessException, InstantiationException,
            InvocationTargetException
    {
        if (configured) {
            throw new IllegalStateException("Configuration is frozen");
