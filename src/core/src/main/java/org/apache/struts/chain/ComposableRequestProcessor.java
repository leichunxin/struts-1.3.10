...
/**
 * <p>
 * ComposableRequestProcessor uses the Chain Of Resposibility design pattern (as
 * implemented by the commons-chain package in Jakarta Commons) to support
 * external configuration of command chains to be used. It is configured via the
 * following context initialization parameters:
 * </p>
 *
 * <ul>
 *
 ...
 *
 * <li>org.apache.struts.chain.COMMAND_NAME - Name of the Command which we will
 * execute for each request, to be looked up in the specified Catalog. If not
 * specified, the default value is servlet-standard.</li>
 *
 * </ul>
 *
...
public class ComposableRequestProcessor extends RequestProcessor {
     ...
     * </p>
     */
    private static final Class[] SERVLET_ACTION_CONTEXT_CTOR_SIGNATURE = new Class[] { ServletContext.class, HttpServletRequest.class,
